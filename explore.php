    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                $execute = mysqli_query($connection, $getAllProjects);
                if (!$execute) {
                    return false;
                } else {
                        ...
                        <div class='col-sm-2 card' style="height: 400px; border-style: solid; border-color: black; border-width: 2px; margin: 5px">
                            ...
                            if (isset($_SESSION['login_user_id'])) {
                                if ($_SESSION['login_user_id'] === $user_id) {
                                    echo '<form action="manage_project.php"> 
                                    <input type="hidden" name="p_id" value="'.$id.'"> 
                                    <input style="width:90%; position: absolute;right:0; bottom:0; margin:15px;" class="btn btn-primary btn-block" type="submit" value="Edit"/>
                                    </form>';
                                } else {
                                    echo '<form action = "project_page.php" method = "get">';
